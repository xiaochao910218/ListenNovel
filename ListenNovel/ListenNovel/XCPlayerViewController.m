...
@interface XCPlayerViewController ()
{
    ...
    XCPlayerModel *_playingModel; // 正在播放的model
...
- (void)updateAudioPlayer{
    ...
    playerItem = [AVPlayerItem playerItemWithURL:[NSURL URLWithString:model.playerUrl]];
...
- (IBAction)disMissSelfClick:(UIButton *)sender {
...
#pragma mark - 后台UI设置
- (void)setLockViewWith:(XCPlayerModel*)model currentTime:(CGFloat)currentTime
{
...
//    [musicInfo setObject:model.singer forKey:MPMediaItemPropertyArtist];
    // 设置歌曲名
    [musicInfo setObject:model.playerTitle forKey:MPMediaItemPropertyTitle];
    // 设置封面
