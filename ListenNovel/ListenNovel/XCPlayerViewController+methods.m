...
- (void)setImageWith:(XCPlayerModel *)model{
    /**
     *  添加旋转动画
     */
    ...
    [self.rotatingView.imageView sd_setImageWithURL:[NSURL URLWithString:model.playersmaImg] placeholderImage:[UIImage imageNamed:@"音乐_播放器_默认唱片头像"] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
        if (image) {
